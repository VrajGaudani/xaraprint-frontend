...
export class MyAccountComponent implements OnInit {
  ...
  updateUser(key: any) {
    ...
    //   country_code: this.formObj.country_code,
    //   phone_no: this.formObj.phone_no,
    //   type: this.formObj.type,
    //   social_id: this.formObj.social_id,
    // }
    let userObj = {
      firstname: this.formObj.firstname,
      lastname: this.formObj.lastname,
    ...
    this.httpService.put(APIURLs.updateProfileAPI,userObj).subscribe((res: any) => {
  ...
  updatePassword() {
    ...
    this.httpService.post(APIURLs.updatePasswordAPI,this.newPaasObj).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
      this.getUserInfo()
      this.newPaasObj = {}
    },(err) => {
  ...
  submit() {
    this.httpService.post(APIURLs.addAdressAPI,this.addressObj).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
  ...
  update() {
    ...
    this.httpService.post(APIURLs.updateAdressAPI,this.addressObj).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
      this.getUserInfo()
      $('#addressModal').modal('hide')
    },(err) => {
  ...
  delete(addressId: any) {
    this.httpService.post(APIURLs.deleteAdressAPI,{addressId}).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
      this.getUserInfo()
    },(err) => {
      this.gs.errorToaster(err?.error?.msg || "something went wrong !!")
  ...
  getUserOrders() {
    this.httpService.get(APIURLs.getOrderAPI).subscribe((res: any) => {
  ...
  getOrder(order_id: any) {
    this.httpService.get(APIURLs.getOrderByIdAPI + '/' + order_id).subscribe((res: any) => {
  ...
  queryOrder(data: any, index: any, msg: any) {
    this.queryObj.query_id = "";
    $('#reasonModal').modal('show');

    this.queryObj.order_id = data._id;
    this.queryObj.order_status = data.order_status;
    this.queryObj.user_id = data.user_id;
    this.queryObj.order_unique_id = data.order_id;
    this.queryObj.message = msg;
    this.queryObj.subject = data.querys.subject || "";
    this.queryObj.description = data.querys.description || "";
    this.queryObj.query_id = data.querys._id || "";
  }

  submitReason() {
    this.httpService.post(APIURLs.addOrderQueryAPI,this.queryObj).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
      this.getUserOrders();
  ...
  updateReason() {
    ...
    this.httpService.post(APIURLs.updateOrderQueryAPI,this.queryObj).subscribe((res: any) => {
      this.gs.successToaster(res?.msg)
      this.getUserOrders();
      $('#reasonModal').modal('hide');
    },(err) => {
